...
1. Preview of Countdown without text under countdown2. Preview of Countdown with text under counter
...
= 1.01 =
* Fixed a path bug.= 1.02 =* Added text under countdown as seen in preview http://premiumcoding.com/wordpress-count-down/.
