...
function wp_xmlURLpath_countDown($file){
	...
	$urlServer = str_replace($blogUrl[2],"",$_SERVER['DOCUMENT_ROOT']);
	$urlPlugin = str_replace("http://","", plugins_url('wp-flash-countdown/'));
...
function XMLCountDown($wNumber,$scalesize,$containerx ,$containery  ,$numbermargin ,$reflection ,$year,$month,$day,$hours,$minute, $imagebackground){
		$xml = '';
...
//      width and height without px only number
	...
	if($custom_widget == '0'){
		XMLCountDown($id, $scalesize, $containerx , $containery  , $numbermargin , $reflection, $year,$month,$day,$hours,$minute,$imagebackground);
...
?> 
    ...
    <b><font size="1">[CountDown id=1 width=250 custom_widget=1 containerx=0 containerxy=0 imagebackground=true reflection=true year=2011 month=7 day=25 hours=5 minute=10]</font></b><br><br>
...
function widget_CountDown_control($args) {
	...
	// write flash 
	if($addSettings == '0'){	
		XMLCountDown($id, $mainoptions['scaleSize'], $mainoptions['ContainerX'] , $mainoptions['ContainerY']  , $mainoptions['numberMargin'] , $mainoptions['reflection'] , $year,$month,$day,$hours,$minute,$imagebackground );
	}
	if($addSettings == '1'){	
		XMLCountDown($id, $scalesize, $containerx ,$containery  ,$numbermargin ,$reflection, $year,$month,$day,$hours,$minute,$imagebackground );
	}
